...
0xf27a, //pga_dark1_hi //Enter Dark1
0xf372, //pga_dark_lo  //Escape Dark1
///////////////////////////////////
...
0x9710, //Indoor_bRgStep
0x9810, //Indoor_bBgStep
...
0x2634,//Indoor_aTgtAngle
0x273e,//Indoor_aTgtAngle_a01
0x2841,//Indoor_aTgtAngle_a02
0x294e,//Indoor_aTgtAngle_a03
0x2a72,//Indoor_aTgtAngle_a04

0x2b10,//Indoor_aRgTgtOfs
0x2c10,//Indoor_aRgTgtOfs_a01
0x2d8e,//Indoor_aRgTgtOfs_a02
0x2e84,//Indoor_aRgTgtOfs_a03
0x2f86,//Indoor_aRgTgtOfs_a04

0x30c6,//Indoor_aBgTgtOfs
0x31c6,//Indoor_aBgTgtOfs_a01
0x32b1,//Indoor_aBgTgtOfs_a02
0x338a,//Indoor_aBgTgtOfs_a03
0x3484,//Indoor_aBgTgtOfs_a04 h88->h00  13.5.29 choi
...
0x8208, //Outdoor_wRgIntOfs_n01    h40->h20  13.5.27  LSC update shift
...
0x1f8b,//Outdoor_aBgTgtOfs_a01
0x2089,//Outdoor_aBgTgtOfs_a02
0x2187,//Outdoor_aBgTgtOfs_a03
0x2284,//Outdoor_aBgTgtOfs_a04
...
0x5656,// LSC Ctmp LTStr In     h56->h56
...
0xbc78,// LSC5_Ind_MiddleTmp     gain r
...
0xc27a,// LSC5_Ind_HighTmp       gain r
...
0xed19, //Outdoor_allgain_y7
0xee18, //Outdoor_allgain_y8
...
0xf61b,//Indoor_delta3	light green
0xf7c2,//Indoor_center3	light green
0xf817,//Indoor_delta4
0xf9fb,//Indoor_center4
...
0x1f0c,//Outdoor 1419
0x201a,
0x2118,//Outdoor 141a //YC2D Post STD gain Pos
0x221b,
0x231d,//Outdoor 141b //YC2D Post STD gain Neg
0x2427,
...
0x3441,
0x351c,//Indoor 1141 //Pre flat R1 STDH
0x3642,
0x3700, //Indoor 1142
0x3843,
0x3900, //Indoor 1143
...
0x1eef,
0x1f6a,//Indoor 11ef //Bayer Flat R3/R4 rate
0x2003,
0x2112,//12 Page
0x2212,
0x2308,//Indoor 1212
...
0x1f0c,//Indoor 1419
0x201a,
0x2118,//Indoor 141a //YC2D Post STD gain Pos
0x221b,
0x231c,//Indoor 141b //YC2D Post STD gain Neg
0x2427,
...
0x2c3d,
0x2d53,//Dark1 113d //Pre Flat R1 DyH
0x2e3e,
0x2f00, //Dark1 113e
0x303f,
0x3100, //Dark1 113f
...
0x3441,
0x352c,//Dark1 1141 //Pre Flat R1 STDH
0x3642,
0x3700, //Dark1 1142
0x3843,
0x3900, //Dark1 1143
...
0xe4d5,
0xe540,//Dark1 11d5 //Bayer Flat R1 STD H
0xe6d6,
0xe700, //Dark1 11d6
0xe8d7,
0xe92a, //Dark1 11d7
...
0xbfff,//Dark1 1A38
0xc039,
0xc111,//Dark1 1A39 //RGB Flat R2_Lum L
0xc23a,
0xc33f,//Dark1 1A3a
0xc43b,
0xc500,//Dark1 1A3b
...
0xe4d5,
0xe540,//Dark2 11d5 //Bayer Flat R1 STD H
0xe6d6,
0xe700, //Dark2 11d6
0xe8d7,
0xe92a, //Dark2 11d7
...
0xbfff,//Dark2 1A38
0xc039,
0xc111,//Dark2 1A39 //RGB Flat R2_Lum L
0xc23a,
0xc33f,//Dark2 1A3a
0xc43b,
0xc500,//Dark2 1A3b
...
tagCamReg16_t sr352_Capture_640_480[] ={
0x03c8,	//AWB Off
0x1052,
...
tagCamReg16_t sr352_Capture_800_480[] ={
...
tagCamReg16_t sr352_Capture_960_720[] ={
...
tagCamReg16_t sr352_Capture_1280_720[] ={
...
tagCamReg16_t sr352_Capture_1280_960[] ={
...
tagCamReg16_t sr352_Capture_1536_864[] ={
...
tagCamReg16_t sr352_Capture_1600_960[] ={
...
tagCamReg16_t sr352_Capture_1600_1200[] ={
...
tagCamReg16_t sr352_Capture_2048_1152[] ={
...
tagCamReg16_t sr352_Capture_2048_1232[] ={
...
tagCamReg16_t sr352_Capture_2048_1280[] ={
...
tagCamReg16_t sr352_Capture_2048_1536[] ={
...
tagCamReg16_t sr352_Enterpreview_640x480[] ={
...
tagCamReg16_t sr352_Enterpreview_720x480[] ={
...
tagCamReg16_t sr352_Enterpreview_800x480[] =
{
...
tagCamReg16_t sr352_Enterpreview_704_576[] =
{
...
0x0326,
0x3028,	// Preview // sleep off ÇØ ÁÜ
...
0x3005,  // l_pkt_wc_h  // Pre = 704 * 2 (YUV)
0x3180,  // l_pkt_wc_l
//------------------------------------//
...
tagCamReg16_t sr352_Enterpreview_1024x576[] =
{
...
tagCamReg16_t sr352_Enterpreview_1024x640[] =
{
...
tagCamReg16_t sr352_Enterpreview_1024x768[] =
{
...
tagCamReg16_t sr352_preview_176_144[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_320_240[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_352_288[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_528_432[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_640_480[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_704_576[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_720_480[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_800_480[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_800_600[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_1024_576[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
tagCamReg16_t sr352_preview_1024_768[] =
{
0x03c1,
0x1006, // ssd tranfer disable
0xff01, 
...
/*============================================*/
#if 1
tagCamReg16_t sr352_recording_50Hz_HD[] = {
...
tagCamReg16_t sr352_recording_50Hz_30fps[] = {
...
tagCamReg16_t sr352_recording_50Hz_25fps[] = {
...
tagCamReg16_t sr352_recording_50Hz_15fps[] = {
...
tagCamReg16_t sr352_recording_50Hz_modeOff[] = {
...
/*=================================
  ...
  ==================================*/
tagCamReg16_t sr352_bright_default[] =
{
0x0310,
0x1402,
0x5d80,
 ...
 *CAMERA_SATURATION_-1 (2/5) m1   *
 ==================================*/
tagCamReg16_t sr352_saturation_m1[] =
{
//level -1
0x03d3,
0x7ba0,	// Cb offset 
 ...
 *CAMERA_SATURATION_0 (3/5) default   *
 ==================================*/
tagCamReg16_t sr352_saturation_0[] =
{
//level 0
0x03d3,
0x7b00,	// Cb offset 
 ...
 *CAMERA_SATURATION_1 (4/5) p1   *
 ==================================*/
tagCamReg16_t sr352_saturation_p1[] =
{
//level 1
0x03d3,
0x7b20,	// Cb offset 
 ...
 *CAMERA_SATURATION_2 (5/5) p2   *
 ==================================*/
tagCamReg16_t sr352_saturation_p2[] =
{
//level 2
0x03d3,
0x7b40,	// Cb offset 
...
tagCamReg16_t sr352_effect_gray[] =
{
0x0310,
0x1103,
0x12f3,
...
tagCamReg16_t sr352_effect_negative[] =
{
0x0310,
0x1103,
0x12f8,
...
tagCamReg16_t sr352_effect_sepia[] =
{
0x0310,
0x1103,
0x12f3,
...
tagCamReg16_t sr352_wb_fluorescent[] =
{
	0x03c8,
	0x1052, //AWB Off
	0x1220, //Adaptive e0, manual 20
...
tagCamReg16_t sr352_wb_incandescent[] =
{
	0x03c8,
	0x1052, //AWB Off
	0x1220, //Adaptive e0, manual 20
...
0xd344,
	...
	0x03c7,
	0x215c, // Band1 Gain 30fps
	0x225c, // Band2 Gain 15fps
	0x235c, // Band3 Gain 12fps
	0x1101, //AE Reset
	0xff01,
	0x4C00,//SW ExpMin	 = 8800
	0x4D00,	
...
0x12e0, //Adaptive e0, manual a0
	...
	0x03c7,
	0x2120, // Band1 Gain 30fps
	0x2220, // Band2 Gain 15fps
	0x2320, // Band3 Gain 12fps
	0x1101, //AE Reset
	0xff01,
	0x4C00,//SW ExpMin	 = 8800
	0x4D00,	
...
/*METERING()                                               */
/*=========================================================*/
tagCamReg16_t sr352_metering_matrix[] = {
...
tagCamReg16_t sr352_setting_60hz[] = {
...
tagCamReg16_t sr352_HD_setting[] = {
...
0x0320,
0x10bd, //50hz bd, 60hz ad
0x2000, //Start ExpTime 120fps // HD 86MHz
0x2105,
0x2272,
0x23ba,
...
tagCamReg16_t sr352_HD_setting_60hz[] = {
...
tagCamReg16_t  sr352_AE_Lock[] = {
0x03c7,
0x1070,	//AE Off 50hz 70, 60hz 50
0xff0a, //delay 100ms
};

tagCamReg16_t  sr352_AE_Unlock[] = {
0x03c7,
0x10f0,	//AE On 50hz f0, 60hz d0
0xff0a, //delay 100ms
};

tagCamReg16_t  sr352_AE_Lock_60hz[] = {
0x03c7,
0x1050,	//AE Off 50hz 70, 60hz 50
0xff0a, //delay 100ms
};

tagCamReg16_t  sr352_AE_Unlock_60hz[] = {
0x03c7,
0x10d0,	//AE On 50hz f0, 60hz d0
0xff0a, //delay 100ms
};

tagCamReg16_t  sr352_AWB_Lock[] = {
0x03c8,
0x1052,	//AWB On
0xff0a, //delay 100ms
};

tagCamReg16_t  sr352_AWB_Unlock[] = {
0x03c8,
0x10d2,	//AWB Off
0xff0a, //delay 100ms
};
