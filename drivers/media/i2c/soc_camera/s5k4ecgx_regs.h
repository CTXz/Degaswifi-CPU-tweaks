...
{0x002A, 0x17F6},
{0x0F12, 0x023C},		//23C 210 258  AWB R point 
{0x0F12, 0x0230},		//230 288 228 ->258 -> 208  AWB B point 
{0x002A, 0x1840},
...
tagCamReg32_t regs_s5k4ecgx_brightness_level_6[]=
{
 ...
 {0x0028, 0x7000},
 {0x002A, 0x1484},
 {0x0F12, 0x0060},  //5C ->60TVAR_ae_BrAve
};
...
{0x0F12, 0x0001},
{0x002A, 0x06C2},
{0x0F12, 0x0180}, //AE haunting, NMG, 0100
...
tagCamReg32_t regs_s5k4ecgx_ISO_50[]=
{
  ...
  //{0x0F12, 0x0000},                                             
	...
	{0x0F12, 0x0001},	//REG_SF_USER_IsoChanged                          
	{0x002A, 0x06C2},                                                   
	{0x0F12, 0x0100}, //AE haunting, NMG, 0100},	//lt_bUseSecISODgain	
...
tagCamReg32_t regs_s5k4ecgx_preview_disable_1280_720[]= 
{
	...
	{0x002A, 0x02A6},
	{0x0F12, 0x0280},  /*REG_0TC_PCFG_usWidth  //Hsize   : 640			*/     
...
tagCamReg32_t regs_s5k4ecgx_preview_800_480[]= 
{
 ...
 {0x0F12, 0x0060}, //senHal_uAddColsBin
 {0x0F12, 0x0060}, //senHal_uAddColsNoBin
 {0x0F12, 0x068c}, //senHal_uMinColsBin
 {0x0F12, 0x068c}, //senHal_uMinColsNoBin
...
tagCamReg32_t regs_s5k4ecgx_preview_640_480[]=
{
	...
	{0x002A, 0x1464},
	{0x0F12, 0x0008},
	{0x0F12, 0x0190},	//0190	awbb_WpFilterMaxThr //
	{0x0F12, 0x00A0}, //00A0	//awbb_WpFilterCoef p //
	{0x0F12, 0x0004},	//0004 awbb_WpFilterSize //
...
tagCamReg32_t regs_s5k4ecgx_preview_176_144[]=
{
 ...
 {0x002A, 0x0250},
 {0x0F12, 0x0928}, //REG_TC_GP_PrevReqInputWidth //2344p
 {0x0F12, 0x0780}, //REG_TC_GP_PrevReqInputHeight //1920
 {0x0F12, 0x007C}, //REG_TC_GP_PrevInputWidthOfs //(2592-2344)/2
 {0x0F12, 0x000C}, //REG_TC_GP_PrevInputHeightOfs //(1944-1920)/2
...
tagCamReg32_t regs_s5k4ecgx_camcorder_640_480[]= 
{
	{0xFCFC, 0xD000},
	{0x0028, 0xD000},
	{0x002A, 0xE410},
...
tagCamReg32_t regs_s5k4ecgx_camcorder_320_240[]= 
{
	{0xFCFC, 0xD000},
	{0x0028, 0xD000},
	{0x002A, 0xE410},
...
//	{0x0F12, 0x002A},	//003C   //TVAR_ae_BrAve p //
	...
	{0x002A, 0x02A6},
	{0x0F12, 0x0140},	/*REG_0TC_PCFG_usWidth  //Hsize   : 320			*/
	{0x0F12, 0x00F0}, /*REG_0TC_PCFG_usHeight//Vsize   : 240       */
