					 ...
					 unsigned long value, void *devp)
{
	...
	int default_value = PM_QOS_DEFAULT_VALUE;
	...
	/*
	 * If required level is larger than all qos_value,
				   ...
				   void *data)
{
	...
	if (profile->qos_list) {
		...
		for (i = 1; profile->qos_list[i].freq; i++) {
			 ...
			 */
			if (WARN((profile->qos_list[i - 1].qos_value >
...
static struct device_attribute devfreq_attrs[] = {
	...
	__ATTR(qos_max_freq, S_IRUGO, show_qos_max_freq, NULL),
	{ },
};
