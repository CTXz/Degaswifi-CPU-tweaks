...
static int pm822_onkey_probe(struct platform_device *pdev)
{
	...
	regmap_update_bits(info->map, PM822_RTC_MISC4, PM822_LONG_ONKEY_EN2,
...
static int pm822_onkey_remove(struct platform_device *pdev)
{
