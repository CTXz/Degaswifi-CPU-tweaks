...
{
	return ((reg < BOBCAT_PREAMP_GAIN_NEG_6DB) ?
		BOBCAT_PREAMP_GAIN_NEG_6DB : (enum d2199_preamp_gain_val)reg);
}
...
enum d2199_mixer_selector_val {
	BOBCAT_MSEL_A1   = 0x01, /* if A is fully diff.
				    then selects A2 as the inverting input */
	BOBCAT_MSEL_B1   = 0x02, /* if B is fully diff.
				    then selects B2 as the inverting input */
	BOBCAT_MSEL_A2   = 0x04, /* if A is fully diff.
				    then selects A1 as the non-inverting input*/
	BOBCAT_MSEL_B2   = 0x08  /* if B is fully diff.
				    then selects B1 as the non-inverting input*/
};
...
enum d2199_hp_vol_val {
	BOBCAT_HPVOL_NEG_57DB,   BOBCAT_HPVOL_NEG_56DB,
	BOBCAT_HPVOL_NEG_55DB,   BOBCAT_HPVOL_NEG_54DB,
	BOBCAT_HPVOL_NEG_53DB,   BOBCAT_HPVOL_NEG_52DB,
	BOBCAT_HPVOL_NEG_51DB,   BOBCAT_HPVOL_NEG_50DB,
	BOBCAT_HPVOL_NEG_49DB,   BOBCAT_HPVOL_NEG_48DB,
	BOBCAT_HPVOL_NEG_47DB,   BOBCAT_HPVOL_NEG_46DB,
	BOBCAT_HPVOL_NEG_45DB,   BOBCAT_HPVOL_NEG_44DB,
	BOBCAT_HPVOL_NEG_43DB,   BOBCAT_HPVOL_NEG_42DB,
	BOBCAT_HPVOL_NEG_41DB,   BOBCAT_HPVOL_NEG_40DB,
	BOBCAT_HPVOL_NEG_39DB,   BOBCAT_HPVOL_NEG_38DB,
	BOBCAT_HPVOL_NEG_37DB,   BOBCAT_HPVOL_NEG_36DB,
	BOBCAT_HPVOL_NEG_35DB,   BOBCAT_HPVOL_NEG_34DB,
	BOBCAT_HPVOL_NEG_33DB,   BOBCAT_HPVOL_NEG_32DB,
	BOBCAT_HPVOL_NEG_31DB,   BOBCAT_HPVOL_NEG_30DB,
	BOBCAT_HPVOL_NEG_29DB,   BOBCAT_HPVOL_NEG_28DB,
	BOBCAT_HPVOL_NEG_27DB,   BOBCAT_HPVOL_NEG_26DB,
	BOBCAT_HPVOL_NEG_25DB,   BOBCAT_HPVOL_NEG_24DB,
	BOBCAT_HPVOL_NEG_23DB,   BOBCAT_HPVOL_NEG_22DB,
	BOBCAT_HPVOL_NEG_21DB,   BOBCAT_HPVOL_NEG_20DB,
	BOBCAT_HPVOL_NEG_19DB,   BOBCAT_HPVOL_NEG_18DB,
	BOBCAT_HPVOL_NEG_17DB,   BOBCAT_HPVOL_NEG_16DB,
	BOBCAT_HPVOL_NEG_15DB,   BOBCAT_HPVOL_NEG_14DB,
	BOBCAT_HPVOL_NEG_13DB,   BOBCAT_HPVOL_NEG_12DB,
	BOBCAT_HPVOL_NEG_11DB,   BOBCAT_HPVOL_NEG_10DB,
	BOBCAT_HPVOL_NEG_9DB,    BOBCAT_HPVOL_NEG_8DB,
	BOBCAT_HPVOL_NEG_7DB,    BOBCAT_HPVOL_NEG_6DB,
	BOBCAT_HPVOL_NEG_5DB,    BOBCAT_HPVOL_NEG_4DB,
	BOBCAT_HPVOL_NEG_3DB,    BOBCAT_HPVOL_NEG_2DB,
	BOBCAT_HPVOL_NEG_1DB,    BOBCAT_HPVOL_0DB,
	BOBCAT_HPVOL_1DB,        BOBCAT_HPVOL_2DB,
	BOBCAT_HPVOL_3DB,        BOBCAT_HPVOL_4DB,
	BOBCAT_HPVOL_5DB,        BOBCAT_HPVOL_6DB,
	BOBCAT_HPVOL_MUTE
};
...
struct d2199_audio {
	...
	u8 AudioStart; /*0=not started, 1=hs starting, 2=ihf starting,
			 3=started*/
};

int d2199_audio_hs_poweron(bool on);
int d2199_audio_hs_shortcircuit_enable(bool en);
int d2199_audio_hs_set_gain(enum d2199_audio_output_sel hs_path_sel,
				enum d2199_hp_vol_val hs_gain_val);
...
int d2199_audio_set_mixer_input(enum d2199_audio_output_sel path_sel,
				enum d2199_audio_input_val input_val);
int d2199_audio_set_input_mode(enum d2199_input_path_sel inpath_sel,
				enum d2199_input_mode_val mode_val);
int d2199_audio_set_input_preamp_gain(enum d2199_input_path_sel inpath_sel,
					enum d2199_preamp_gain_val pagain_val);
