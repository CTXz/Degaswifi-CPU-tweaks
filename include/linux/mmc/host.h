...
#define MMC_CAP_UHS_SDR12	(1 << 17)	/* Host supports UHS SDR12 mode */
#define MMC_CAP_UHS_SDR25	(1 << 19)	/* Host supports UHS SDR25 mode */
#define MMC_CAP_UHS_SDR50	(1 << 20)	/* Host supports UHS SDR50 mode */
#define MMC_CAP_UHS_SDR104	(1 << 21)	/* Host supports UHS SDR104 mode */
#define MMC_CAP_UHS_DDR50	(1 << 22)	/* Host supports UHS DDR50 mode */
